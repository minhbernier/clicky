...
struct BlueCursorView: View {
    ...
    var body: some View {
        // The user-selected cursor accent color, applied to the triangle,
        // waveform, spinner, and speech bubbles below.
        let cursorColor = companionManager.cursorColor
        return ZStack {
            ...
            BlueCursorWaveformView(audioPowerLevel: companionManager.currentAudioPowerLevel, cursorColor: cursorColor)
...
class OverlayWindowManager {
    ...
    func showOverlay(onScreens screens: [NSScreen], companionManager: CompanionManager) {
        ...
        for screen in screens {
            ...
            // The window is already positioned at screen.frame.origin via OverlayWindow.init.
            // Using screen.frame here (non-zero origin on secondary monitors) would offset
